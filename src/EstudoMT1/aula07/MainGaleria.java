                ...
                case 1:
                    ...
                    switch (opcaoProduto) {
                        case 1:
                            ...
                            galeria.adicionarObra(new Quadro(nome, autor, precoBase, colorType, emoldurada, size));
                            break;
                        case 2:
                            ...
                            galeria.adicionarObra(new Escultura(nomeE, autorE, precoBaseE, material, numbers));
                            break;
                        case 3:
                            ...
                            galeria.adicionarObra(new ObraDigital(nomeN, autorN, precoBaseN, nomeBlockchain, endereco));
                            break;
                    }
                    break;
                case 2:
                    ...
                    HashMap<Integer,Obra> obras = galeria.getGaleria();
